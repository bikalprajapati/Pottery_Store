...
if (isset($_POST['user_update'])) {
    ...
    //update query
    $update_data = "update `user_table` set username='$username',user_email='$user_email',user_image='$user_image',user_address='$user_address',
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data" class="text-center">
        ...
        <!-- <div class="form-outline mb-4">
            <input type="text" class="form-control w-50 m-auto" name="user_password">
        </div> -->
